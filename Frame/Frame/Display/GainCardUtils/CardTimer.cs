...
namespace RandomGains.Frame.Display
{
    internal class CardTimer
    {
        ...
        public CardTimer(FContainer container, IOwnCardTimer ownCardTimer)
        {
        ...
        public class SingleNumber
        {
            ...
            public SingleNumber(CardTimer cardTimer, int digit)
            {
    ...
    public interface IOwnCardTimer
    {
        int CurrentCount { get; }
        bool HideBelowZero { get; }
    }
}
