...
{
    internal class NeedleSpearGain : GainImpl<NeedleSpearGain, NeedleSpearGainData>
    {
        public override GainID GainID => NeedleSpearGainEntry.NeedleSpearGainID;
    }

    internal class NeedleSpearGainData : GainDataImpl
    {
        public override GainID GainID => NeedleSpearGainEntry.NeedleSpearGainID;
    }

    internal class NeedleSpearGainEntry : GainEntry
    {
        public static GainID NeedleSpearGainID = new GainID("NeedleSpear", true);

        public override void OnEnable()
        {
            GainRegister.RegisterGain<NeedleSpearGain, NeedleSpearGainData, NeedleSpearGainEntry>(NeedleSpearGainID);
        }
