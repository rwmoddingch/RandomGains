...
{
    internal class SpearMasterGainEntry : GainEntry
    {
        public static GainID spearMasterGainID = new GainID("SpearMaster", true);
        public override void OnEnable()
        {
            GainRegister.RegisterGain<SpearMasterGain,SpearMasterGainData,SpearMasterGainEntry>(spearMasterGainID);
        }
    ...
    class SpearMasterGainData : GainDataImpl
    {
        public override GainID GainID => SpearMasterGainEntry.spearMasterGainID;
    }

    class SpearMasterGain : GainImpl<SpearMasterGain, SpearMasterGainData>
    {
        public override GainID GainID => SpearMasterGainEntry.spearMasterGainID;
