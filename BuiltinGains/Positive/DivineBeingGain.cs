...
{
    internal class DivineBeingGain : GainImpl<DivineBeingGain, DivineBeingGainData>
    {
        public override GainID GainID => DivineBeingGainEntry.DivineBeingGainID;
    }

    internal class DivineBeingGainData : GainDataImpl
    {
        public override GainID GainID => DivineBeingGainEntry.DivineBeingGainID;
    }

    internal class DivineBeingGainEntry : GainEntry
    {
        public static GainID DivineBeingGainID = new GainID("DivineBeing", true);

        public override void OnEnable()
        {
            var bundle = AssetBundle.LoadFromFile(AssetManager.ResolveFilePath("gainassets/assetBundle/builtinbundle"));
            ...
            GainRegister.RegisterGain<DivineBeingGain, DivineBeingGainData, DivineBeingGainEntry>(DivineBeingGainID);
        }
