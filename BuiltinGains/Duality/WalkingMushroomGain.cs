...
{
    internal class WalkingMushroomGain : GainImpl<WalkingMushroomGain, WalkingMushroomGainData>
    {
        public override GainID GainID => WalkingMushroomGainEntry.WalkingMushroomGainID;
    }

    internal class WalkingMushroomGainData : GainDataImpl
    {
        public override GainID GainID => WalkingMushroomGainEntry.WalkingMushroomGainID;
    }

    internal class WalkingMushroomGainEntry : GainEntry
    {
        public static GainID WalkingMushroomGainID = new GainID("WalkingMushroom", true);
        ...
        {
            GainRegister.RegisterGain<WalkingMushroomGain, WalkingMushroomGainData, WalkingMushroomGainEntry>(WalkingMushroomGainID);
        }
    ...
    public class MushroomModule
    {
        ...
        void FindNewGoalPos(Mushroom self)
        {
            ...
            nextCoord = null;
            idealPath.Clear();
            EmgTxCustom.Log($"{self} find new goal pos {goal}:{self.room.GetTile(goal).Terrain}");
        }
